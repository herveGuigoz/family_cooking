  ...
  <div class="flex flex-col justify-center items-center">
    <div class="h-6 w-12 flex justify-center items-end">
      <transition v-if="userInteractionCount" name="click-counter" mode="out-in">
        <div :key="userInteractionCount" class="absolute opacity-0 h-7 w-7 -mt-3 flex items-center justify-center rounded-full bg-rose text-xs text-white font-semibold">
