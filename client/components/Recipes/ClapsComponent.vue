<template>
  <div class="flex">
    <div class="w-64 h-64 flex flex-col justify-center items-center border border-teal-500">
      ...
      <div :key="totalCount" class="particles-container mt-8 z-0" :style="randomRotationAngle(1, 72)">
