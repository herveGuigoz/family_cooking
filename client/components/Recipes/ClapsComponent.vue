<template>
  <div class="flex">
    <div class="w-64 h-64 flex flex-col justify-center items-center">
      ...
      <div id="particles" class="particles-container mt-8 z-0">
        <div v-for="(particlesClasse) in particlesClasses" :key="particlesClasse" class="triangle">
          <div class="square"></div>
        </div>
      </div>
      <div id="particles-2" class="particles-container mt-8 z-0">
        <div v-for="(particlesClasse) in particlesClasses" :key="particlesClasse" class="triangle">
          <div class="square"></div>
        </div>
      </div>
      <div id="particles-3" class="particles-container mt-8 z-0">
        <div v-for="(particlesClasse) in particlesClasses" :key="particlesClasse" class="triangle">
          <div class="square"></div>
        </div>
      </div>
    ...
    <div class="w-64 h-64 flex flex-col justify-center items-center">
      <claps-component-clean/>
    </div>
  </div>
</template>

<script>
  import ClapsComponentClean from "./ClapsComponentClean";
export default {
  name: "ClapsComponent",
  components: {
    ClapsComponentClean
