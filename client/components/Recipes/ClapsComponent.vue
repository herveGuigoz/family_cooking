<template>
  <div class="w-56 h-40 flex flex-col justify-center items-center">
    ...
    <transition name="fadein" mode="out-in">
      <div :key="totalCount" class="text-xs text-gray-600">
        {{ totalCount }}
      </div>
    </transition>
