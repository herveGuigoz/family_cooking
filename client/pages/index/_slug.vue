  ...
  <div class="flex-1 flex flex-col h-screen text-brown">
    <div class="relative">
      <div class="flex items-center justify-between px-5 py-4 border-b h-16">
        ...
        <div class="flex items-center">
          <button v-if="$store.getters.getNextRecipeInList(slug)" @click="toNextRecipe">
          ...
          <button v-if="$store.getters.getPreviousRecipeInList(slug)" class="ml-2" @click="toPreviousRecipe">
            <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <div class="p-3 flex-1 overflow-y-auto">
      <div class="recipe-header flex px-3 my-6">
        <div class="flex">
          ...
          <h1 class="ml-6 mt-6 font-bold text-2xl">
            {{ title | truncate(36) }}
          </h1>
        </div>
